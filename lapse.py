...
while(True):
  ...
  if screenMode == 1:
    ...
    label = myfont.render("Motor:" , 1, (255,255,255))
    screen.blit(label, (10, 10))
    label = myfont.render("Zai:" , 1, (255,255,255))
    screen.blit(label, (10, 70))
    label = myfont.render("Zurag:" , 1, (255,255,255))
  ...
  if screenMode == 0:
    ...
    label = myfont.render("Niit tsag:" , 1, (255,255,255))
    screen.blit(label, (10,130))
